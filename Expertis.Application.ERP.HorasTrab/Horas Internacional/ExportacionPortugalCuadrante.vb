...
Public Class ExportacionPortugalCuadrante
    ...
    Public Sub generaExcel()
        ...
        FormaTablaSalidaDCZ(dtFinal, Fecha1, Fecha2)
    ...
    Public Sub FormaTablaSalidaDCZ(ByRef dtFinal As DataTable, ByVal fecha1 As String, ByVal fecha2 As String)
        ' Las columnas fijas
        ...
        dtFinal.Columns.Add("OBSERVACIONES", GetType(String))
    ...
    Public Sub setSegundoCambioForma(ByRef dtFinal As DataTable, ByVal fecha1 As String, ByVal fecha2 As String)
        ...
        For Each dr As DataRow In dtFinal.Rows
            ...
            While fechaActual <= fechaFin
                ...
                Dim colDia As String = dia & "/" & mes & "/" & año

                ' Si las columnas existen en la tabla
                If dtFinal.Columns.Contains(colDia) Then
                    ...
                    If dt.Rows.Count > 0 Then
                        ...
                        If IsNumeric(suma) Then
                            dr(colDia) = suma
                        Else
                            ' Si no es numérico, verifica si IDCausa tiene longitud > 0
                            If Not String.IsNullOrEmpty(idCausa) Then
                                dr(colDia) = idCausa ' Asignar el valor de IDCausa
                            Else
                                dr(colDia) = DBNull.Value ' O puedes asignar 0 si prefieres
                            End If
                        End If
                    End If
    ...
    Private Sub CrearHojaEmpleados(ByVal package As ExcelPackage, ByVal dtFinal As DataTable)
        Dim worksheet = package.Workbook.Worksheets.Add("PORTUGAL")
