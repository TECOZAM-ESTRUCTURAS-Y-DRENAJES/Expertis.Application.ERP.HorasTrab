Public Class frmDatosInforme
    ...
    Private Sub btnAceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAceptar.Click
        ...
        Else
            ...
            Else
                If cbxMes.Value > Today.Month And cbAnio.Value > (Year(Today) - 1) Then
                    MsgBox("No se puede introducir una fecha superior a la actual")
                Else
                    mes = cbxMes.Value
                    anio = cbAnio.Value
